        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto w-full">
          ...
          <div className="lg:col-span-8 space-y-6 md:space-y-8">
            ...
            <section className="relative rounded-[2rem] overflow-hidden aspect-[2/1] sm:aspect-[3.5/1] shadow-xl group">
              {HERO_SLIDES.map((slide, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex flex-col justify-center px-6 md:px-12 text-white">
                    <h1 className="text-xl md:text-4xl font-bold font-headline max-w-md leading-tight animate-in slide-in-from-left-4 duration-700">
                      {slide.title}
                    </h1>
                    <p className="mt-2 md:mt-4 text-[10px] md:text-base opacity-90 max-w-xs md:max-w-sm">
                      {slide.description}
                    </p>
                  </div>
                </div>
              ...
              <div className="hidden md:flex absolute bottom-8 left-12 right-12 z-20 items-center bg-white rounded-2xl p-1 shadow-2xl max-w-xl">
            ...
            {/* Quick Service Grid (Phase 2 Refinement) */}
              ...
              {[
                ...
                <Link key={i} href={item.href} className="group shrink-0 sm:shrink">
                  <div className="flex flex-col items-center gap-1 md:gap-2 p-1 md:p-2 rounded-2xl md:rounded-3xl transition-all hover:bg-white hover:shadow-md">
                    <div className={cn("h-12 w-12 md:h-16 md:w-16 rounded-xl md:rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg", item.color)}>
                      <item.icon className="h-6 w-6 md:h-8 md:w-8" />
                    </div>
                    <div className="text-center">
                      <p className="text-[9px] font-bold uppercase tracking-tight md:text-xs text-slate-700">{item.title}</p>
                    </div>
                  </div>
                </Link>
              ))}
                  ...
                  <Link key={provider.id} href={`/providers/${provider.id}`}>
                    <Card className="border-none shadow-md rounded-[1.5rem] overflow-hidden group hover:shadow-lg transition-all">
                      ...
                      <CardContent className="p-2 md:p-3">
                        <h4 className="font-bold text-[10px] md:text-xs truncate text-slate-800">{provider.name}</h4>
                        ...
                        <p className="text-[8px] md:text-[9px] text-muted-foreground mt-1">Starting from ₹499</p>
                      </CardContent>
                    </Card>
                  </Link>
                ))}
          ...
          <div className="lg:col-span-4 space-y-6 md:space-y-8">
                ...
                {[
                  ...
                  <div key={i} className={cn(
                    ...
                    <div className="overflow-hidden">
                      <p className="text-[10px] md:text-xs font-bold truncate text-slate-800">{pet.name}</p>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="space-y-3 md:space-y-4">
                {upcomingBooking ? (
                   <Card className="border-none shadow-md rounded-3xl p-3 md:p-4 flex gap-3 md:gap-4 bg-white relative overflow-hidden group hover:shadow-lg transition-all">
                      ...
                      <div className="flex-grow space-y-1">
                        <div className="flex items-center justify-between">
                           <h4 className="text-xs md:text-sm font-bold text-slate-800 truncate">{upcomingBooking.serviceType}</h4>
                           <Badge className="bg-green-100 text-green-700 hover:bg-green-100 border-none text-[7px] md:text-[8px] font-bold">Confirmed</Badge>
                        </div>
                        ...
                        <p className="text-[10px] md:text-xs font-bold text-primary mt-1 md:mt-2 truncate">{upcomingBooking.serviceProviderName}</p>
                      </div>
                   </Card>
                ) : (
